...
{
    public class PPDEntryDetailRecord : IEntryDetailRecord
    {
        ...
        // Trancode identifies transaction type (ex: 22 = credit to checking, 27 = debit to checking).
        ...
        // Optional field to help identify the transaction to the Receiver (e.g., invoice or employee number).
        public string IdentificationNumber { get; private set; }

        // FIELD 8: Receiving Individual/Company Name
        // Position: 55-76 | Length: 22 | Required: Yes | Content: Alphanumeric
        // Name of the Receiver for identification purposes.
        public string ReceivingIndividualName { get; private set; }
        ...
        public PPDEntryDetailRecord(
            ...
            string receivingIndividualName,            // Field 8
        ...
        )
        {
            ...
            ReceivingIndividualName = NachaHelper.PadRight(receivingIndividualName, 22);                    // Field 8: Always 22 characters
        ...
        // Generate the NACHA-formatted 94-character PPD Entry Detail Record line
        public string Generate()
        {
            ...
            record.Append(ReceivingIndividualName);                                          // Field 8: Receiving Individual/Company Name | Length: 22
            ...
            return record.ToString();                                                        // Returns the full 94-character PPD Entry Detail Record line
        }
